...
var buttonStyle={};function Market(){var menu={'Buy Top Item':{disabled:function disabled(){return!!getTopItemElement();},onClick:function onClick(){var e=getTopItemElement();// listen for changes on the market list,
