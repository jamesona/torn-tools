...
var listItemElements=function listItemElements(){return Array.from(document.querySelectorAll('.items .item'));};function Market(){var functions=Object.values({LogElements:function LogElements(){listItemElements().forEach(console.log);}});return react_default.a.createElement("div",null,functions.map(function(f){return react_default.a.createElement("span",{onClick:function onClick(){return f();}},f.name);}));}/* harmony default export */ var src_Market = (Market);
